...
import mainSchool from '../assets/images/img-school-5-min.jpg';
import mainSchool1 from '../assets/images/img-school-1-min.jpg';
import mainSchool2 from '../assets/images/img-school-2-min.jpg';
import mainSchool3 from '../assets/images/img-school-3-min.jpg';
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-5 mr-auto mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="0">
                        <img src={mainSchool} alt="image" className="img-fluid" />
                    </div>
                                    ...
                                    <div className="accordion-body">
                                        <div className="d-flex">
                                            <div className="accordion-img mr-4">
                                                <img src={mainSchool1} alt="Image" className="img-fluid" />
                                            </div>
                                            <div>
                                                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                            ...
                            <div className="accordion-item">
                                ...
                                <div id="collapseTwo" className="collapse" aria-labelledby="headingTwo" data-parent="#accordion_1">
                                    <div className="accordion-body">
                                        <div className="d-flex">
                                            <div className="accordion-img mr-4">
                                                <img src={mainSchool2} alt="Image" className="img-fluid" />
                                            </div>
                                            <div>
                                                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                                                <p>Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean.</p>
                            ...
                            <div className="accordion-item">
                                ...
                                <div id="collapseThree" className="collapse" aria-labelledby="headingThree" data-parent="#accordion_1">
                                    <div className="accordion-body">
                                        <div className="d-flex">
                                            <div className="accordion-img mr-4">
                                                <img src={mainSchool3} alt="Image" className="img-fluid" />
                                            </div>
                                            <div>
